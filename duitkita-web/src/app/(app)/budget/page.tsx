...
import { Lock, Plus, Wallet, Repeat, ChevronRight } from "lucide-react";
          ...
          <>
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-foreground">Pengeluaran Rutin</p>
                <p className="text-xs text-muted-foreground">
                  Kelola tagihan & langganan berulang
                </p>
              </div>
